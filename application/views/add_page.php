             ...
             <div id = "content">
                    ...
                    <div  id = "right_content">
                            <form     action = "<?php  echo site_url('add/add')?>"method = "POST">
                                  <div>
                                        标题&nbsp;<font  style = "color:red">*</font>: <input type = "text"  name = "title"    value = ""  placeholder = "title"/>
                                 </div>
                                 <div  style = "margin-top:20px">
                                        标签&nbsp;<font  style = "color:red">*</font>:
                                                <select  name = "tag">
                                                         <?php  
                                                               foreach($tags as $row)
                                                               {
                                 ...
                                 <div style = "margin-top:30px">
                                      正文&nbsp;<font  style = "color:red">*</font>:<textarea id="editor_id" name="content" style="width:690px;height:700px;">
                                                  </textarea>
                                  </div>
                                  <div   style = "margin-top:30px">
